...
<!-- Please read https://github.com/linuxserver/docker-readarr/blob/nightly/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Freadarr%2Fnightly%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/readarr/nightly/index.html)
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/readarr:nightly
    ```
